...
description: Guide générique de revue de code (Python, CSS, sécurité, performance, architecture). Invocation manuelle uniquement (/code-review-excellence) ; pour ce projet, préférer l'agent verificateur-code.
