...
from ministere_de_l_info.etl.loaders.circonscriptions import load_circonscriptions
...
from ministere_de_l_info.etl.loaders.populations import load_populations
